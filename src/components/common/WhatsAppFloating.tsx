...
const WhatsAppFloating: React.FC = () => {
  const whatsappHref =
    'https://wa.me/5492916433000?text=Hola%20Natalia%2C%20tengo%20una%20consulta';
  ...
  return (
    ...
    >
      <span className="sr-only">Escribime por WhatsApp</span>
      <div className="w-14 h-14 rounded-full shadow-lg flex items-center justify-center bg-[#25D366] hover:brightness-95 transition-all">
